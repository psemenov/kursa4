...
@NamedQueries({
        @NamedQuery(name = "MagicSkills.readAll" , query = "Select p from MagicSkillsEntity p") ,
        @NamedQuery(name = "MagicSkills.deleteAll" , query = "delete from MagicSkillsEntity p")
})
