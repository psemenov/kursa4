...
@NamedQueries({
        @NamedQuery(name = "Organization.readAll" , query = "Select p from OrganizationEntity p") ,
        @NamedQuery(name = "Organization.deleteAll" , query = "delete from OrganizationEntity p")
})
